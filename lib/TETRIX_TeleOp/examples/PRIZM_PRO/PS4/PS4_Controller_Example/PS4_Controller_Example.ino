 ...
 *  Author: PWU
 *  
 *  For TETRIX PRIZM PRO Controller
 * 
 *  This example demonstrates how to read the SONY PS4 gaming controller's Digital buttons, Analog Trigger buttons and Joysticks using the TETRIX TeleOP module connected to TETRIX PRIZM PRO robotics controller.
 ...
 *  ps4.Button(PB);       returns digital boolean value of POWER button           (0 = unpressed, 1 = pressed)
