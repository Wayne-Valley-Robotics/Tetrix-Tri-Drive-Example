 ...
 * 
 *  This example demonstrates how to read the SONY PS5 gaming controller's Digital buttons, Analog Trigger buttons and Joysticks using the TETRIX TeleOP module connected to TETRIX PRIZM PRO robotics controller.
